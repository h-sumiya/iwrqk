...
class ApiProvider {
  ...
  static Future<ApiResult<void>> register(
    ...
    await networkProvider
        .post(
          "/user/register",
          data: {"email": email},
          headers: {"x-captcha": "$captchaId:$attemptedValue"},
        )
        .then((value) {
          message = value.data["message"];
  ...
  static Future<ApiResult<List<RuleModel>>> getRules() async {
    ...
    return ApiResult(data: rules, success: message == null, message: message);
  }
  ...
  static Future<ApiResult<void>> updateAppUser({
    ...
    return networkProvider
        ...
        .then(
          (value) =>
              ApiResult(data: null, success: message == null, message: message),
        );
  }
  ...
  static Future<ApiResult<GroupResult<ConversationModel>>> getConversations(
    ...
    int count = 0;
    await networkProvider
        .get("/user/$userId/conversations", queryParameters: {"page": pageNum})
        .then((value) {
          if (value.data["message"] != null) {
            message = value.data["message"];
          } else {
  ...
  static Future<ApiResult<void>> sendMessage({
    ...
    await networkProvider
        .post("/conversation/$conversationId/messages", data: {"body": content})
        .then((value) {
          message = value.data["message"];
        })
        .catchError((e, stackTrace) {
  ...
  static Future<ApiResult<int>> getUsersCount({required String path}) async {
    ...
    int? count;
    await networkProvider
        .get(path, queryParameters: {"limit": 1})
        .then((value) {
          if (value.data["message"] != null) {
            message = value.data["message"];
          } else {
  ...
  static Future<ApiResult<GroupResult<CommentModel>>> getComments({
    ...
    await networkProvider
        .get("/$type/$id/comments", queryParameters: {"page": pageNum})
        .then((value) async {
          if (value.data["message"] != null) {
            message = value.data["message"];
          } else {
            ...
            for (var commentJson in value.data["results"]) {
              ...
              if (comment.numReplies > 0 && isPreview) {
                await networkProvider
                    .get(
                      "/$type/$id/comments",
                      queryParameters: {"parent": comment.id, "limit": 2},
                    )
                    .then((value) {
                      if (value.data["message"] != null) {
                        throw value.data["message"];
    ...
    return ApiResult(
      data: GroupResult(count: count, results: comments),
      success: message == null,
      message: message,
    );
  }
  ...
  static Future<ApiResult<GroupResult<CommentModel>>> getReplies({
    ...
    await networkProvider
        .get(
          "/$sourceType/$sourceId/comments",
          queryParameters: {"parent": parentId, "page": pageNum},
        )
        .then((value) {
          if (value.data["message"] != null) {
            message = value.data["message"];
  ...
  static Future<ApiResult<List<ResolutionModel>>> getVideoResolutions(
    ...
    await networkProvider
        .getFullUrl(url, headers: {"x-version": xversion})
        .then((value) {
          if (value.data is List) {
            resolutions = List.from(
              value.data.map((e) => ResolutionModel.fromJson(e)),
            );
          } else {
            message = value.data["message"];
          }
  ...
  static Future<ApiResult<GroupResult<MediaModel>>> getFavoriteMedia({
    ...
    String path = type == MediaType.video
        ? "/favorites/videos"
        : "/favorites/images";

    await networkProvider
        .get(path, queryParameters: {"page": currentPage})
        .then((value) {
          message = value.data["message"];
  ...
  static Future<ApiResult<GroupResult<UserModel>>> getUsers({
    ...
    return ApiResult(
      data: GroupResult(count: count, results: users),
      success: message == null,
      message: message,
    );
  }
  ...
  static Future<ApiResult<List<ChannelModel>>> getForumChannels() async {
    ...
    await networkProvider
        ...
        .then((value) {
          if (value.data is List) {
            channels = List.from(
              value.data.map((e) => ChannelModel.fromJson(e)),
            );
          } else {
            message = value.data["message"];
          }
  ...
  static Future<ApiResult<GroupResult<ThreadModel>>> getChannelThreads({
    ...
    await networkProvider
        .get("/forum/$channelName", queryParameters: {"page": pageNum})
        .then((value) {
          message = value.data["message"];
          ...
          if (message != null) {
            ...
            count = value.data["count"];
            threads = List.from(
              value.data["threads"].map((e) => ThreadModel.fromJson(e)),
            );
          }
        })
        .catchError((e, stackTrace) {
  ...
  static Future<ApiResult<ThreadModel>> getThread({
    ...
    return ApiResult(data: thread, success: message == null, message: message);
  }
  ...
  static Future<ApiResult<GroupResult<PostModel>>> getThreadPosts({
    ...
    await networkProvider
        ...
        .then((value) {
          ...
          if (message != null) {
            ...
            count = value.data["count"];
            posts = List.from(
              value.data["results"].map((e) => PostModel.fromJson(e)),
            );
          }
        })
        .catchError((e, stackTrace) {
    ...
    return ApiResult(
      data: GroupResult(count: count, results: posts),
      success: message == null,
      message: message,
    );
  }
  ...
  static Future<ApiResult<void>> createThread({
    ...
    return networkProvider
        .post(
          "/forum/$channelName",
          data: {"section": channelName, "title": title, "body": content},
        )
        .then((value) {
  ...
  static Future<ApiResult<void>> sendPost({
    ...
    await networkProvider
        .post("/forum/$threadId/reply", data: {"body": content})
        .then((value) {
          message = value.data["message"];
        })
        .catchError((e, stackTrace) {
  ...
  static Future<ApiResult<void>> editPost({
    ...
    await networkProvider
        .put("/forum/post/$id", data: {"body": content})
        .then((value) {
          message = value.data["message"];
        })
        .catchError((e, stackTrace) {
  ...
  static Future<ApiResult<void>> deletePost({required String id}) async {
    String? message;
  ...
  static Future<ApiResult<List<TagModel>>> autoCompleteTags({
    ...
    return networkProvider
        .get("/autocomplete/tags", queryParameters: {"query": keyword})
        .then((value) {
          if (value.data["message"] != null) {
            message = value.data["message"];
          } else {
        ...
        .then(
          (value) =>
              ApiResult(data: tags, success: message == null, message: message),
        );
  }
  ...
  static Future<ApiResult<List<TagModel>>> searchTags({
    ...
    return networkProvider
        .get("/tags", queryParameters: {"query": keyword})
        .then((value) {
          if (value.data["message"] != null) {
            message = value.data["message"];
          } else {
  ...
  static Future<ApiResult<void>> unfollowUser({required String userId}) async {
    String? message;
  ...
  static Future<ApiResult<GroupResult<UserModel>>> getFriends({
    ...
    int count = 0;
    await networkProvider
        .get("/user/$userId/friends", queryParameters: {"page": pageNum})
        .then((value) {
          if (value.data["message"] != null) {
            message = value.data["message"];
          } else {
  ...
  static Future<ApiResult<void>> unfriend({required String userId}) async {
    String? message;
  ...
  static Future<ApiResult<GroupResult<FriendRequestModel>>> getFriendRequests({
    ...
    return ApiResult(
      data: GroupResult(count: count, results: requests),
      success: message == null,
      message: message,
    );
  }

  static Future<ApiResult<void>> favoriteMedia({required String id}) async {
    String? message;
  ...
  static Future<ApiResult<void>> unfavoriteMedia({required String id}) async {
    String? message;
  ...
  static Future<ApiResult<void>> createPlaylist({required String title}) async {
    String? message;

    await networkProvider
        .post("/playlists", data: {"title": title})
        .then((value) {
          message = value.data["message"];
        })
        .catchError((e, stackTrace) {
  ...
  static Future<ApiResult<void>> editPlaylistTitle({
    ...
    await networkProvider
        .put("/playlist/$playlistId", data: {"title": title})
        .then((value) {
          message = value.data["message"];
        })
        .catchError((e, stackTrace) {
  ...
  static Future<ApiResult<GroupResult<PlaylistModel>>> getPlaylists({
    ...
    await networkProvider
        .get("/playlists", queryParameters: {"user": userId, "page": pageNum})
        .then((value) {
          message = value.data["message"];
    ...
    return ApiResult(
      data: GroupResult(count: count, results: playlists),
      success: message == null,
      message: message,
    );
  }
  ...
  static Future<ApiResult<String>> getPlaylistName({
    ...
    return ApiResult(data: name, success: message == null, message: message);
  }
  ...
  static Future<ApiResult<List<LightPlaylistModel>>> getLightPlaylists({
    ...
    await networkProvider
        .get("/light/playlists", queryParameters: {"id": videoId})
        .then((value) {
          if (value.data is List) {
  ...
  static Future<ApiResult<void>> editComment({
    ...
    await networkProvider
        .put("/comment/$id", data: {"body": content})
        .then((value) {
          message = value.data["message"];
        })
        .catchError((e, stackTrace) {
  ...
  static Future<ApiResult<void>> deleteComment({required String id}) async {
    String? message;
  ...
  static Future<ApiResult<int?>> getFileSize(String url) async {
    try {
      int? size;
      await networkProvider
          .getFullUrl(url, headers: {"range": "bytes=0-1"})
          .then((value) {
            size = int.parse(
              (value.headers.map["content-range"]![0])
                  .split("/")
                  .last
                  .replaceAll(" ", ""),
            );
